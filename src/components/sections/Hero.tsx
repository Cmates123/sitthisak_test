...
export default function Hero() {
  return (
    <section className="relative min-h-dvh flex items-start justify-center text-center px-5 pt-28 sm:pt-36 md:pt-48 lg:pt-72 pb-12 bg-[#EEF0F8] overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto w-full">
        <h1 className="leading-[1.13] tracking-tight text-[#0F1117] mb-6" style={{ fontSize: '24px', fontWeight: 600 }}>
          {HERO.headline}
        </h1>

        <p className="text-[#6B7280] leading-relaxed max-w-lg mx-auto mb-10" style={{ fontSize: '16px' }}>
          {HERO.subtitle}
        </p>
